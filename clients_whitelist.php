...
$result_busca = "SELECT * FROM whitelist ORDER BY id asc limit 4" ;
$resultado = mysqli_query($connect, $result_busca);
$con = $connect->query($result_busca) or die($mysqli->error);
  while($dado = $con->fetch_array()) { ?>
        <a href="clients_whitelist_corrigir.php?id=<?php echo $dado['user'];?>">
            <div class="d-flex justify-content-center align-items-center whitelistbox">
                <div class="d-flex justify-content-center align-items-center flex-row">
                    <img style="width:100px; height:100px; margin-right: 30px; " src="avatar/<?php echo $row_usuario['avatar']; ?>" alt="">
            <div>
                    <h5 class="text-white mb-4">User: <?php echo $dado['user']; ?>
                    </h5>   <h5 class="text-white mb-4">A Whitelist está pendente. Clique para edita-la.
                    </div>
                    </h5>
   ...
   while($dado = $con->fetch_array()) { ?>
        <a href="clients_whitelist_corrigir.php?id=<?php echo $dado['user'];?>">
            <div class="d-flex justify-content-center align-items-center whitelistbox">
                <div class="d-flex justify-content-center align-items-center flex-row">
                    <img style="width:100px; margin-right: 30px; " src="img/cj.png" alt="">
            <div>
                    <h5 class="text-white mb-4">User: <?php echo $dado['user']; ?>
                    </h5>   <h5 class="text-white mb-4">A Whitelist está pendente. Clique para edita-la.
                    </div>
