        ...
        <section class="conteudo d-flex justify-content-center align-items-center">
            <div class="d-flex justify-content-center align-items-center box">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    ...
                    <h6 class="text-white text-center"><?php if(isset($_SESSION['callback'])){echo $_SESSION['callback']; unset($_SESSION['callback']);}?></h6>
                        <form action="proc_cadastro.php" method="POST">
                            <div class="item-form mb-3">
                                <label for="">User (O nome que vai pro jogo) <span>*</span></label>
                            ...
                            <div class="item-form mb-3">
                                <label for="">Password <span>*</span></label>
                                <input name="confirmsenha" type="password" required>
                            </div>
