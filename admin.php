...
<body>
    ...
    <section class="main d-flex justify-content-center align-items-center flex-column">
        <a href="clients_whitelist.php"><div class="d-flex justify-content-center align-items-center adminbox">
            <div class="d-flex justify-content-center align-items-center flex-column text-center">
                <img style="width:300px; " src="img/whitelist.png" alt="">

                <h5 class="text-white mb-4">Aprove ou desaprove a Whitelist dos
jogadores
                </h5>
            </div>
